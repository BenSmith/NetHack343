...
if NOT exist ..\..\win\win32\NetHack.sln goto skipsoln
echo Copying ..\..\win\win32\NetHack.sln  ..\..\NetHack.sln
copy ..\..\win\win32\NetHack.sln  ..\.. >nul
:skipsoln
...
if NOT exist ..\..\win\win32\nethackw.vcproj goto skipVC2008
